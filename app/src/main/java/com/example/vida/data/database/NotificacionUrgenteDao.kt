...
object NotificacionUrgenteDao {
    ...
    fun getNotificacionesFiltradas(hospital: String?, paciente: String?, tipo: String?): List<NotificacionUrgente> {
        val connection = getConexion()
